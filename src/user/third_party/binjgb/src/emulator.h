...
typedef u8 FramePixel;
#else
typedef RGBA FramePixel;
#endif
typedef FramePixel FrameBuffer[SCREEN_WIDTH * SCREEN_HEIGHT];
typedef FramePixel SgbFrameBuffer[SGB_SCREEN_WIDTH * SGB_SCREEN_HEIGHT];
